...
export const StoryboardEditor: React.FC<StoryboardEditorProps> = ({ story, onAddPage, onEditPage, onPreviewStory, onBack }) => {
  return (
    <div className="min-h-screen p-4 sm:p-8 bg-slate-100">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <button onClick={onAddPage} className="border-2 border-dashed border-slate-300 rounded-xl flex flex-col items-center justify-center text-slate-500 hover:border-indigo-500 hover:text-indigo-600 transition-colors p-6 min-h-[180px]">
            <PlusIcon />
